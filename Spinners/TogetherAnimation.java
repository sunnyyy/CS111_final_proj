...
{ 
    public TogetherAnimation()
    {
        ...
        this.addSprite(new TreeLinerSprite(0, 1.0, 0.5, 45, 0.7, 0.5, 1,
                                           Color.pink));
        this.addSprite(new TreeLinerSprite(0, 0.8, 0.7, 40, 0.6, 0.6, 1,
                                           Color.green));
        this.addSprite(new TreeLinerSprite(0, 0.9, 0.3, 25, 0.45, 0.65, 1,
                                           Color.blue));
        this.addSprite(new TreeLinerSprite(0, 0.75, 0.6, 30, 0.65, 0.5, 1,
                                           Color.magenta));
